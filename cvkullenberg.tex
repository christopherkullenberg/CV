...
978-91-87853-17-3.\\
  ...
  - Andreas Nord, Johan Järlehed \& Christopher Kullenberg, href{http://www2.nordiska.uu.se/konferens/svebe36/sammandrag/nord-jarlehed-kullenberg/}{För anslagstavlan i tiden: Vad händer på svenska anslagstavlor?}, \emph{Svenskans beskrivning}, Uppsala University, 25–27 october 2017.\\
  ...
  With Dick Kasperowski I developed the course \href{http://files.christopherkullenberg.se/kursplaner/KT2110.pdf}{``Communication of Scientific Knowledge''}.\\
    ...
    % - övrig
        ...
        \subsubsection{Media \& Communication Studies, Strategic Communication: Courses}
             ...
             \begin{enumerate}
             % Lägg in länk till louise sjöström och de andra som finns i gupea
           ...
           % Lägg till ny sektion om att jag examinerat Julia Ahlkvist

             \subsubsection{Information architecture studies: Thesis examination, bachelor's Degree}
             % Uppdatera med fulltextlänkar när de publicerats
             \begin{enumerate}
